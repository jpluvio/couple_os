    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-400 mt-0.5">Track spending together</p>
            </div>
            ...
            <div className="flex bg-gray-100 rounded-xl p-1 gap-1">
                {[
                    ...
                    <button key={t.id} onClick={() => setSubTab(t.id)} className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${subTab === t.id ? "bg-white shadow-sm text-gray-900" : "text-gray-500 hover:text-gray-700"}`}>
                        {t.label}
                    </button>
                ))}
            </div>
